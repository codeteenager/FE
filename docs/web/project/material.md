...
那么我们管理平台如何去获取私有库的数据呢，这时候我们需要一个媒介unpkg去帮平台拉取私有库的数据，unpkg 是一个前端常用的公共 CDN，你可以通过URL形式访问npm包中的资源，例如：https://unpkg.com/react@16.14.0/umd/react.production.min.js。具体可以看[使用unpkg来读取我们私有库的包](https://zhuanlan.zhihu.com/p/84119287)。整体流程如下：
