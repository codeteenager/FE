...
那么我们应该去选用那些工具来搭配完成工程化的规划呢？我们可以参考create-react-app、vue-cli、angular-cli、gatsby-cli等官方脚手架，它不是一个工具，而是一个成熟的工程化集成方案。以vue-cli为例，它不仅创建了一个项目，同时提供了项目代码组织结构、代码的校验、Web服务热更新等功能。
